...
from algo.maddpg.bootmaddpg import BootMADDPG
    ...
    while episode < args.max_episodes:
        ...
        while True:
            ...
            if args.mode == "train":
                ...
                if args.algo == "maddpg" or args.algo == "commnet" or args.algo=="bootmaddpg":
                    ...
                    if args.algo == "maddpg" or "bootmaddpg":
                        model.memory.push(obs.data, ac_tensor, next_obs, rw_tensor)
                    obs = next_obs
                else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', default="bootmaddpg", type=str, help="commnet/bicnet/maddpg")
    ...
    parser.add_argument('--episode_before_train', default=300, type=int)
