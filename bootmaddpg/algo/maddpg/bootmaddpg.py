from algo.maddpg.network import Critic, Actor, EnsembleCrt
import torch
from copy import deepcopy
from torch.optim import Adam
from algo.memory import ReplayMemory, Experience, BootMemory, BootExp
...
class BootMADDPG:
    def __init__(self, dim_obs, dim_act, n_agents, args):
        ...
        self.critics = [EnsembleCrt(n_agents, dim_obs, dim_act,self.n_ensemble) for _ in range(n_agents)]
